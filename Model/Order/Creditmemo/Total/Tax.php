...
use Magento\Sales\Model\Order\Creditmemo\Total\Tax as MagentoTax;
    ...
    public function collect(Creditmemo $creditmemo)
    {
        ...
        if (!$order->canUnhold() && !$order->isCanceled() && $order->getState() != Order::STATE_CLOSED
            ...
            foreach ($creditmemo->getAllItems() as $item) {
                ...
                $orderItemTax     = (double)$orderItem->getTaxAmount();
                $baseOrderItemTax = (double)$orderItem->getBaseTaxAmount();
                $orderItemQty     = (double)$orderItem->getQtyOrdered();
            ...
            $allowedTax                         = $order->getTaxAmount() - $order->getTaxRefunded() - $creditmemo->getTaxAmount();
            $allowedBaseTax                     = $order->getBaseTaxAmount() - $order->getBaseTaxRefunded() - $creditmemo->getBaseTaxAmount();
