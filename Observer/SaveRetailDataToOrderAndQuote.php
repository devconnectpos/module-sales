...
class SaveRetailDataToOrderAndQuote implements ObserverInterface
{
    ...
    public function execute(Observer $observer)
    {
        ...
        $promotionalCardCouponCode = $this->registry->registry('promotional_card_coupon_code');
        if (!!$promotionalCardCouponCode) {
            $quote->setData('promotional_card_coupon_code', $promotionalCardCouponCode);
            $order->setData('promotional_card_coupon_code', $promotionalCardCouponCode);
        }
    }
}
